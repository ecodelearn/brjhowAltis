...
_minWeatherChangeTimeMin = 240; // 20
...
// (Suggested value: 20).
_maxWeatherChangeTimeMin = 241; //40
...
_minTimeBetweenWeatherChangesMin = 240; //5
...
_maxTimeBetweenWeatherChangesMin = 241; //10
